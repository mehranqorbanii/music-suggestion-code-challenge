...
public class GenreCityHandler extends AbstractRequestHandler {

    private static GenreCityHandler instance;

    private GenreCityHandler() {
    }
    ...
    private Stream<AlbumDetail> filterAlbumsByGenre(String genre, List<AlbumDetail> albums) {
